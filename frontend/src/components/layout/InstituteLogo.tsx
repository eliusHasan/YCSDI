  ...
  return (
    <Link className="inline-flex items-center gap-[22px]" to="/">
      ...
      <span className="grid text-[26px] font-black uppercase leading-[1.15] tracking-normal">
        <span className={isFooter ? "text-white" : "text-theme-dark"}>Youth Career & Skills</span>
        <span className={isFooter ? "text-white" : "text-theme-accent"}>Development Training</span>
      </span>
    </Link>
  );
}
